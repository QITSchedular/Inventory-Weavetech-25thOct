    ...
    <Container>
      ...
      >
        ...
        <DefaultNavbarLink
            ...
            light={light}
          />
          <DefaultNavbarLink icon="person" name="Forgot Password" route="/authentication/forgot-password" light={light} />
          <DefaultNavbarLink icon="donut_large" name="FAQ's" route="/authentication/faq" light={light} />
          <DefaultNavbarLink
            icon="account_circle"
            name="sign up"
